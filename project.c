...
void vegrecipelist(){
    ...
    printf("4.Mysorepak              \t");
    printf("5.Coffee                 \t");
    printf("6.DoubleKaMeetha         \n");
    printf("7.Gulab Jamun            \t");
    printf("8.Pongal                 \t");
    printf("9.Chocolate Brownie      \n");
    printf("10.Masala Dosa           \t");
    printf("11.Rasmalai              \t");
    printf("12.Vegetable Manchuria   \n");
    printf("13.Kitkat Milkshake      \t");
    printf("14.Samosa                \t");
    printf("15.Pizza                 \n");
    printf("16.Frenchfries           \t");
    printf("17.Chocolate Chip Cookies\t");
    printf("18.Vegetable StirFry     \n");
    printf("19.Paneer Butter Masala  \t");
    printf("20.Kulfi                 \n");
}
void vegrecipeselect(){
  ...
  printf("ENTER THE NUMBER OF THE RECIPE YOU WANT TO MAKE\n");
    ...
    case 11:  rasmalai();
              break;
    case 12:  vegetablemanchuria();
              break;
    case 13:  kitkatmilkshake ();
              break;
    case 14:  samosa();
              break;
    case 15:  pizza();
    ...
    case 16:  frenchfries();
              break;
    case 17: chocolateChipCookies();
              break;
    case 18:  vegetableStirFry();
              break;
    case 19:  paneerbuttermasala();
              break;
